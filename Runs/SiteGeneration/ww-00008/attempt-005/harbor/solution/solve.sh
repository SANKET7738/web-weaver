...
# never during regular agent runs. This means the oracle has no need to
# read /ground_truth/, so it works under the same agent-user permission
# model as a normal agent.
