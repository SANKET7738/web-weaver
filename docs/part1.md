...
## Part 2 (animations): see `docs/part2.md`

Motion-design graders (mp4 recordings + Claude vision rubric)
live in their own doc — see [`part2.md`](part2.md) for the
animation grader catalog, pseudo-code, and first-run results.
